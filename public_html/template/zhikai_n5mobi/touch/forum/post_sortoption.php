...
<table cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><div id="select_$option[identifier]"> 
        ...
        <!--{/if}-->
        <div id="sortattach_image_{$option[identifier]}" class="n5_flsctp mtn"> 
          <!--{if $option['value']['url']}--> 
        ...
        <textarea name="typeoption[{$option[identifier]}]" tabindex="1" id="typeoption_$option[identifier]" rows="$option[rowsize]" cols="23" onBlur="checkoption('$option[identifier]', '$option[required]', '$option[type]', 0, 0{if $option[maxlength]}, '$option[maxlength]'{/if})" $option[unchangeable] class="pt">$option[value]</textarea>
        <!--{/if}--> 
        <!--{if $option["unit"]}--> 
