...
<title><!--{if !empty($navtitle)}-->我的二维码 - <!--{/if}--><!--{if empty($nobbname)}--> $_G['setting']['bbname'] - <!--{/if}--> {lang waptitle} - Powered by Discuz!</title>
...
<div class="n5_tbys cl">
	...
	<span class="dqym">我的二维码</span>
</div>
<div class="n5_tbxj"></div>

<div class="n5_wdewm cl">
    <div class="ewmyh cl">
	    <div class="ewmtx cl"><!--{avatar($_G[uid])}--></div>
		<div class="ewmmc cl">$_G[username]<p>扫扫二维码，查看我的主页</p></div>
	</div>
	<div class="wemtp cl"><img src="http://qr.liantu.com/api.php?w=800&m=0&el=q&text=$_G['setting'][siteurl]/home.php?mod=space%26uid=$_G['uid']%26do=profile%26view=me%26mobile=2"></div>
</div>
