	...
	<div class="post_msg_from">
		<ul>
			...
			<li class="bl_none area">
				<textarea class="pt" tabindex="2" autocomplete="off" value="" cols="80" rows="7" id="sendmessage" name="message" placeholder="{lang thread_content}"></textarea>
			</li>
		</ul>
	</div>
</div>
<div class="n5_fxxdyan"><button id="pmsubmit_btn" class="btn_pn btn_pn_grey" disable="true"><span>{lang sendpm}</span></button></div>
<!-- main postbox start -->
</form>
