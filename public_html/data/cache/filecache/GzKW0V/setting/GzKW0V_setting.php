...
{time}',
    ...
    array (
      ...
      array (
        0 => 'invite_aboc',
        1 => 'crx349_copyrighted',
        2 => 'it618_firstnfocus_deyi',
        3 => 'touclick',
        4 => 'nimba_thot',
        5 => 'drk_ledadv',
        6 => 'levnav',
        7 => 'kx_new100',
        8 => 'rpancn_buy_usergroup',
        9 => 'wechat',
        10 => 'pcmgr_url_safeguard',
        11 => 'mobile',
        12 => 'security',
        13 => 'soso_smilies',
        14 => 'qqconnect',
    ...
    array (
      ...
      array (
        ...
        array (
          'module' => 
          array (
            'invite_aboc' => 'invite_aboc/invite_aboc',
      ...
      array (
        ...
        array (
          'module' => 
          array (
            'crx349_copyrighted' => 'crx349_copyrighted/crx349_copyrighted',
            'touclick' => 'touclick/touclick',
    ...
    array (
      ...
      array (
        'navname' => '邀请注册',
        'filename' => 'plugin.php?id=invite_aboc:invite_aboc',
        'available' => '1',
        'navid' => 'mn_Nc36a',
        'level' => '0',
        'nav' => 'id="mn_Nc36a" ><a href="plugin.php?id=invite_aboc:invite_aboc" hidefocus="true"  >邀请注册</a',
      ),
      2 => 
      array (
        'navname' => '论坛',
...
{fdu9tbc1}
<dl class="pil cl">
	<dt>{QIQqGwiw}</dt><dd>{Pu1d7aWd}</dd>
</dl>
{p9221wyx}
<dl class="pil cl">{oDc7kFy7}</dl>',
          'top' => '<dl class="cl">
<dt>{CpZLP9Lg}</dt><dd>{DrLc51Qr}</dd>
</dl>',
        ),
      ),
      'code' => 
