...
$data = array (
  ...
  array (
    ...
    'username' => 'admin',
    'styleid' => '0',
    'blockstyle' => 'a:10:{s:4:"name";s:0:"";s:10:"blockclass";s:12:"forum_thread";s:9:"makethumb";i:0;s:6:"getpic";i:0;s:10:"getsummary";i:0;s:9:"settarget";i:0;s:7:"moreurl";i:0;s:6:"fields";a:4:{i:0;s:5:"views";i:1;s:12:"currentorder";i:2;s:3:"url";i:3;s:5:"title";}s:8:"template";a:9:{s:3:"raw";s:698:"<div class="n5_ztphmk cl">
    <div class="n5_tbzxbt cl"><a href="#">更多</a>主题排行</div>
	<div class="n5_ztphnr cl">
	    <ul>
		    [index=1]<li><span class="y">{views}</span><span class="ztphpx ztphpg">{currentorder}</span><a href="{url}">{title}</a></li>[/index]
			[index=2]<li><span class="y">{views}</span><span class="ztphpx ztphpg">{currentorder}</span><a href="{url}">{title}</a></li>[/index]
			[index=3]<li><span class="y">{views}</span><span class="ztphpx ztphpg">{currentorder}</span><a href="{url}">{title}</a></li>[/index]
			[loop]<li><span class="y">{views}</span><span class="ztphpx">{currentorder}</span><a href="{url}">{title}</a></li>[/loop]
		</ul>
	</div>
</div>";s:6:"footer";s:0:"";s:6:"header";s:0:"";s:9:"indexplus";a:0:{}s:5:"index";a:3:{i:1;s:115:"<li><span class="y">{views}</span><span class="ztphpx ztphpg">{currentorder}</span><a href="{url}">{title}</a></li>";i:2;s:115:"<li><span class="y">{views}</span><span class="ztphpx ztphpg">{currentorder}</span><a href="{url}">{title}</a></li>";i:3;s:115:"<li><span class="y">{views}</span><span class="ztphpx ztphpg">{currentorder}</span><a href="{url}">{title}</a></li>";}s:9:"orderplus";a:0:{}s:5:"order";a:0:{}s:8:"loopplus";a:0:{}s:4:"loop";s:108:"<li><span class="y">{views}</span><span class="ztphpx">{currentorder}</span><a href="{url}">{title}</a></li>";}s:4:"hash";s:8:"8253731e";}',
    'picwidth' => '0',
    'picheight' => '0',
    'target' => 'blank',
    'dateformat' => 'Y-m-d',
